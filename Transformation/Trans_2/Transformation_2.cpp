...
#define vertexShader_path "/Users/TT/Desktop/OpenGl/LearningOpenGL/Transformation/Trans_2/shader.vs"
#define fragmentShader_path "/Users/TT/Desktop/OpenGl/LearningOpenGL/Transformation/Trans_2/shader.fs"
...
int main()
{
    ...
    data = stbi_load(image_path2, &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        trans = glm::mat4(1.0f);
        trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
        trans = glm::scale(trans, glm::vec3(1.0f, 1.0f, 1.0f) - (float)glfwGetTime() * 0.1f);
